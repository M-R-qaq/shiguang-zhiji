...
### ✅ 已完成 (v0.3)
- [x] 多TTS引擎支持（OpenAI/讯飞/MiMo）
- [x] TTS语音锁定（角色固定语音）
- [x] 记忆系统增强（饮食偏好分类、生命周期管理）

### ✅ 已完成 (v0.4)
- [x] 食光鉴搜索系统（Bilibili多策略搜索）
- [x] 关怀推送融入对话流程
- [x] 角色提示词模块化重构
...
### ✅ 已完成 (v0.6)
- [x] 食光鉴独立弹窗（TTS播完后自动弹出，5s自动关闭）
- [x] 会话历史浏览界面（列表+详情+继续对话）
- [x] 后端单元测试框架（pytest）
- [x] Token黑名单自动清理
- [x] CORS配置可配置化
- [x] 安全配置加固
...
### 📋 待开发
- [ ] 唤醒词本地检测集成（sherpa-onnx）
- [ ] speaking视频口型同步（LiveTalking/实时音频驱动）
- [ ] 性能优化（faster-whisper/FlatList/缓存）
- [ ] 离线模式
