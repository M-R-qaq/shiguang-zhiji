...
export default function DiagnosticsScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.buttonRow}>
        ...
        >
          {running ? (
            ...
            <Text style={styles.runButtonText}>▶ 开始测试</Text>
          )}
        </TouchableOpacity>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={styles.cleanButton} onPress={async () => {
          const cacheDir = FileSystem.cacheDirectory;
          if (!cacheDir) return;
          try {
            const files = await FileSystem.readDirectoryAsync(cacheDir);
          ...
          <Text style={styles.cleanButtonText}>🧹 清理缓存文件</Text>
        </TouchableOpacity>
      </View>
                    ...
                    <View
                      style={[
                        styles.metricFill,
                        {
                          ...
                          backgroundColor: result.metric <= result.threshold ? '#4CAF50' : result.metric <= result.threshold * 2 ? '#FF9800' : '#f44336',
                        },
                      ]}
                    />
